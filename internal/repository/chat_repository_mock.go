...
func (_mock *MockChatRepository) CreateRoom(ctx context.Context, id uuid.UUID, name string, description string, roomType string, isPublic bool, isRP bool, channelKind string, createdBy uuid.UUID) error {
	ret := _mock.Called(ctx, id, name, description, roomType, isPublic, isRP, channelKind, createdBy)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, string, string, string, bool, bool, string, uuid.UUID) error); ok {
		r0 = returnFunc(ctx, id, name, description, roomType, isPublic, isRP, channelKind, createdBy)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - channelKind string
//   - createdBy uuid.UUID
func (_e *MockChatRepository_Expecter) CreateRoom(ctx any, id any, name any, description any, roomType any, isPublic any, isRP any, channelKind any, createdBy any) *MockChatRepository_CreateRoom_Call {
	return &MockChatRepository_CreateRoom_Call{Call: _e.mock.On("CreateRoom", ctx, id, name, description, roomType, isPublic, isRP, channelKind, createdBy)}
}

func (_c *MockChatRepository_CreateRoom_Call) Run(run func(ctx context.Context, id uuid.UUID, name string, description string, roomType string, isPublic bool, isRP bool, channelKind string, createdBy uuid.UUID)) *MockChatRepository_CreateRoom_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockChatRepository_CreateRoom_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID, name string, description string, roomType string, isPublic bool, isRP bool, channelKind string, createdBy uuid.UUID) error) *MockChatRepository_CreateRoom_Call {
	_c.Call.Return(run)
	return _c
}
...
// EnsureMember provides a mock function for the type MockChatRepository
func (_mock *MockChatRepository) EnsureMember(ctx context.Context, roomID uuid.UUID, userID uuid.UUID) error {
	ret := _mock.Called(ctx, roomID, userID)

	if len(ret) == 0 {
		panic("no return value specified for EnsureMember")
	}
...
// MockChatRepository_EnsureMember_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EnsureMember'
type MockChatRepository_EnsureMember_Call struct {
	*mock.Call
}

// EnsureMember is a helper method to define mock.On call
//   - ctx context.Context
//   - roomID uuid.UUID
//   - userID uuid.UUID
func (_e *MockChatRepository_Expecter) EnsureMember(ctx any, roomID any, userID any) *MockChatRepository_EnsureMember_Call {
	return &MockChatRepository_EnsureMember_Call{Call: _e.mock.On("EnsureMember", ctx, roomID, userID)}
}

func (_c *MockChatRepository_EnsureMember_Call) Run(run func(ctx context.Context, roomID uuid.UUID, userID uuid.UUID)) *MockChatRepository_EnsureMember_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockChatRepository_EnsureMember_Call) Return(err error) *MockChatRepository_EnsureMember_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockChatRepository_EnsureMember_Call) RunAndReturn(run func(ctx context.Context, roomID uuid.UUID, userID uuid.UUID) error) *MockChatRepository_EnsureMember_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockChatRepository_GetMemberNickname_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMemberNickname'
type MockChatRepository_GetMemberNickname_Call struct {
	*mock.Call
}
...
func (_c *MockChatRepository_GetMemberNickname_Call) Return(s string, err error) *MockChatRepository_GetMemberNickname_Call {
...
// ListAllChannels provides a mock function for the type MockChatRepository
func (_mock *MockChatRepository) ListAllChannels(ctx context.Context, viewerID uuid.UUID, includeSystem bool) ([]ChatRoomRow, error) {
	ret := _mock.Called(ctx, viewerID, includeSystem)
	...
	var r0 []ChatRoomRow
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool) ([]ChatRoomRow, error)); ok {
		return returnFunc(ctx, viewerID, includeSystem)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool) []ChatRoomRow); ok {
		r0 = returnFunc(ctx, viewerID, includeSystem)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ChatRoomRow)
		}
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, bool) error); ok {
		r1 = returnFunc(ctx, viewerID, includeSystem)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockChatRepository_ListAllChannels_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListAllChannels'
type MockChatRepository_ListAllChannels_Call struct {
	*mock.Call
}
...
//   - viewerID uuid.UUID
//   - includeSystem bool
func (_e *MockChatRepository_Expecter) ListAllChannels(ctx any, viewerID any, includeSystem any) *MockChatRepository_ListAllChannels_Call {
	return &MockChatRepository_ListAllChannels_Call{Call: _e.mock.On("ListAllChannels", ctx, viewerID, includeSystem)}
}

func (_c *MockChatRepository_ListAllChannels_Call) Run(run func(ctx context.Context, viewerID uuid.UUID, includeSystem bool)) *MockChatRepository_ListAllChannels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockChatRepository_ListAllChannels_Call) Return(chatRoomRows []ChatRoomRow, err error) *MockChatRepository_ListAllChannels_Call {
	_c.Call.Return(chatRoomRows, err)
	return _c
}

func (_c *MockChatRepository_ListAllChannels_Call) RunAndReturn(run func(ctx context.Context, viewerID uuid.UUID, includeSystem bool) ([]ChatRoomRow, error)) *MockChatRepository_ListAllChannels_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockChatRepository_ListRoomMediaURLs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListRoomMediaURLs'
type MockChatRepository_ListRoomMediaURLs_Call struct {
	*mock.Call
}
...
func (_c *MockChatRepository_ListRoomMediaURLs_Call) Return(strings []string, err error) *MockChatRepository_ListRoomMediaURLs_Call {
	_c.Call.Return(strings, err)
	return _c
}
